                ...
                isSignedIn ?
                    (
                        <div className="flex-auto w-full h-screen ">
                            <img src="https://i.goopics.net/b8ava9.jpg" className="w-full h-full object-cover" alt="messi"/>
                            <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 font-semibold text-center rounded-3xl  shadow-lg p-20 max-w-3xl">
                                <img class="mb-3 w-32 h-34 rounded-full shadow-lg mx-auto" src={auth.currentUser.photoURL} alt="messi" />
                    ...
                    (
                        <div className="flex-auto w-full h-screen ">
                            <img src="https://i.goopics.net/by8pjt.jpg" className="w-full h-full object-cover object-top" alt="ney" />
